...
mock_modules = {
    "splunk_connect_for_snmp.snmp.tasks": MagicMock(),
    "splunk_connect_for_snmp.splunk.tasks": MagicMock(),
    "celery": MagicMock(),
    "celery.utils.log": MagicMock(),
    "opentelemetry": MagicMock(),
    "opentelemetry.sdk.trace": MagicMock(),
    "pysnmp.carrier.asyncio.dgram": MagicMock(),
    "pysnmp.entity.engine": MagicMock(),
    "pysnmp.hlapi": MagicMock(),
    "pysnmp.entity.rfc3413": MagicMock(),
    "splunk_connect_for_snmp.snmp.const": MagicMock(),
}
...
class TestDecodeSecurityContext(TestCase):
    ...
    def test_valid_snmpv3_message(self):
        ...
        engine_id, username = decode_security_context(hexstr)
        self.assertEqual(engine_id, "800000c1010a010fc4")
        self.assertEqual(username, "snmp-poller")
    ...
    def test_exception(self):
        ...
        engine_id, username = decode_security_context(None)
        self.assertIsNone(engine_id)
        self.assertIsNone(username)
