...
class TestEnrich(TestCase):
    ...
    def test_check_restart(self, m_task_manager):
        ...
        result = {"SOME_KEY": {"metrics": {"SNMPv2-MIB.sysUpTime": {"value": 30, "type": "m", "oid": "1.2.3.4.5"}}}}
        ...
        self.assertEqual({'$set': {'sysUpTime': {'value': 30, 'type': 'm', 'oid': '1.2.3.4.5'}}}, calls[0][0][1])
    ...
    def test_check_restart_not_applied(self, m_task_manager):
        ...
        m_task_manager.return_value = periodic_obj_mock
        current_target = {"sysUpTime": {"value": 40}}
        result = {"SOME_KEY": {"metrics": {"SNMPv2-MIB.sysUpTime": {"value": 50, "type": "m", "oid": "1.2.3.4.5"}}}}
        targets_collection = Mock()
        ...
        self.assertEqual({'address': '192.168.0.1'}, calls[0][0][0])
        self.assertEqual({'$set': {'sysUpTime': {'value': 50, 'type': 'm', 'oid': '1.2.3.4.5'}}}, calls[0][0][1])
