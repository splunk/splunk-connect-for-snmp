...
simple_profiles = {"BaseUpTime": {"frequency": 60, "condition": {"type": "field", "field": "SNMPv2-MIB.sysDescr",
                                                                 "patterns": ["^MIKROTIK"]}}}
...
class TestProfilesAssignment(TestCase):
    ...
    def test_assignment_of_base_profiles(self):
        profiles = {"BaseUpTime": {"frequency": 60, "condition": {"type": "base"}},
    ...
    def test_assignment_of_field_profiles(self):
        profiles = {"BaseUpTime": {"frequency": 60, "condition": {"type": "field", "field": "SNMPv2-MIB.sysDescr",
                                                                  "patterns": ["^MIKROTIK"]}},
                    "MyProfile": {"frequency": 60, "condition": {"type": "field", "field": "SNMPv2-MIB.sysName",
                                                                 "patterns": ["Debian"]}},
                    "OtherProfile": {"frequency": 60, "condition": {"type": "field", "field": "SNMPv2-MIB.sysContact",
                                                                    "patterns": ["@splunk"]}}}
    ...
    def test_assignment_of_static_and_smart_profiles(self):
        profiles = {"profile1": {"frequency": 20}, "profile2": {"frequency": 30},
        ...
        result = assign_profiles(ir, profiles, {})
        self.assertEqual({60: ['BaseUpTime'], 30: ['profile5', 'profile2'], 20: ['profile1']}, result)
