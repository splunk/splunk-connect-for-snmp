...
from splunk_connect_for_snmp.inventory.tasks import generate_poll_task_definition, inventory_setup_poller
...
class TestInventorySetupPoller(TestCase):
    ...
    def test_inventory_setup_poller(self, m_get_inventory, m_assign_profiles, m_find_one, m_task_manager, m_load_profiles):
        ...
        self.assertEqual({'address': '192.168.0.1', 'profiles': {'BaseUpTime'}, 'frequency': 60}, calls[0][1]["kwargs"])
        self.assertEqual({'address': '192.168.0.1', 'profiles': {'profile2', 'profile5'}, 'frequency': 30}, calls[1][1]["kwargs"])
        self.assertEqual({'address': '192.168.0.1', 'profiles': {'profile1'}, 'frequency': 20}, calls[2][1]["kwargs"])

        periodic_obj_mock.delete_unused_poll_tasks.assert_called_with("192.168.0.1",
                       ['sc4snmp;192.168.0.1;60;poll', 'sc4snmp;192.168.0.1;30;poll', 'sc4snmp;192.168.0.1;20;poll'])
