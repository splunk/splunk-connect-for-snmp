...
class TestProcessSnmpData(TestCase):
    ...
    @patch('time.time')
    def test_multiple_metrics_single_group(self, m_time, m_extract_index_number,
                                           m_map_metric_type, m_get_group_key, m_resolved):
        ...
        varBindTable = [(var_bind_mock1_1, var_bind_mock1_2), (var_bind_mock2_1, var_bind_mock2_2)]
        metrics = {}
        mapping = {}
        ...
        self.assertEqual({'QWERTYUIOP': {'fields': {},
                                         'metrics': {'IF-MIB.some_metric': {'oid': '1.2.3.4.5.6.7',
                                                                            ...
                                                                            'type': 'g',
                                                                            'value': 65.0},
                                                     'UDP-MIB.next_metric': {'oid': '9.8.7.6',
                                                                             'time': 1640609779.473053,
                                                                             'type': 'g',
                                                                             'value': 123.0}}}}, metrics)
    ...
    @patch('splunk_connect_for_snmp.snmp.manager.extract_index_number')
    @patch('time.time')
    def test_multiple_metrics_multiple_groups(self, m_time, m_extract_index_number,
                                              m_map_metric_type, m_get_group_key, m_resolved):
        poller = Poller.__new__(Poller)
        ...
        self.assertEqual({'GROUP1': {'fields': {},
                                     'metrics': {'IF-MIB.some_metric': {'oid': '1.2.3.4.5.6.7',
                                                                        'time': 1640609779.473053,
                                                                        'type': 'g',
                                                                        'value': 65.0}}},
                          'GROUP2': {'fields': {},
                                     'metrics': {'UDP-MIB.next_metric': {'oid': '9.8.7.6',
                                                                         'time': 1640609779.473053,
                                                                         'type': 'g',
                                                                         'value': 123.0}}}}, metrics)
    ...
    @patch('splunk_connect_for_snmp.snmp.manager.extract_index_number')
    @patch('time.time')
    def test_metrics_and_fields(self, m_time, m_extract_index_number,
                                m_map_metric_type, m_get_group_key, m_resolved):
        poller = Poller.__new__(Poller)
        ...
        self.assertEqual({'GROUP1': {'fields': {'UDP-MIB.some_field': {'oid': '9.8.7.6',
                                                                       'time': 1640609779.473053,
                                                                       'type': 'r',
    ...
    @patch('splunk_connect_for_snmp.snmp.manager.extract_index_number')
    @patch('time.time')
    def test_metrics_with_profile(self, m_time, m_extract_index_number,
                                  m_map_metric_type, m_get_group_key, m_resolved):
        poller = Poller.__new__(Poller)
        ...
        self.assertEqual({'QWERTYUIOP': {'fields': {},
                                         'metrics': {'IF-MIB.some_metric': {'oid': '1.2.3.4.5.6.7',
                                                     ...
                                                     'UDP-MIB.next_metric': {'oid': '9.8.7.6',
                                                                             ...
                                                                             'type': 'g',
                                                                             'value': 123.0}},
                                         'profiles': ['profile1', 'profile2']}}, metrics)
