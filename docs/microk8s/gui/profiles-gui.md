...
SC4SNMP [profiles](../../configuration/profiles.md) can be configured in `Profiles` tab.
...
Configuration of the profile is the same as in the `values.yaml` file. For details check [Configuring profiles](../../configuration/profiles.md).
