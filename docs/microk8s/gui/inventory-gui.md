...
SC4SNMP [inventory](../microk8s/configuration/poller-configuration.md#poller-configuration-file) can be configured in `Inventory` tab.
...
Configuration of the device is the same as in the `inventory.yaml` file [(check here)](../microk8s/configuration/poller-configuration.md#poller-configuration-file).
