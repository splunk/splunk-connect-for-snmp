...
| `trap.includeUnresolvedVarbinds.enabled`       | Include trap varbinds that could not be MIB-translated under `sc4snmp::unresolved` in Splunk events                             | `false`                                     |
| `trap.maxVarbindsToDecode`                   | Maximum varbinds to decode per trap (1–500); excess varbinds are dropped                                                        | `250`                                       |
| `traps.maxVarbindsToDecode`                  | Same limit on the trap receiver (should match worker trap)                                                                    | `250`                                       |
