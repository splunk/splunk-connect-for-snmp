...
| `poller.taskTimeout`                           | Task timeout in seconds for poller tasks (usually necessary when the walk process takes a long time)                            | `2400`                                      |
| `discovery.taskTimeout`                        | Task timeout in seconds for a single discovery task. Increase for large subnets to accommodate the nmap scan and SNMP checks    | `2400`                                      |
