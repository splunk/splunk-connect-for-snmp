...
The inventory defines which devices SC4SNMP should poll, at what interval, using which SNMP version and credentials, and which profiles to apply.
...
| `secret`          | The reference to the SNMPv3 secret that should be used to poll from the device. See [SNMPv3 configuration](snmpv3.md) for details.                                                                                                      |         | NO       |
