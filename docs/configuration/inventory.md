...
| `smart_profiles`  | Enables smart profiles. Its allowed values are `true` or `false`. For more datails see [smart profiles](profiles.md#smartprofile-configuration).                                                                                    | `true`  | NO       |
