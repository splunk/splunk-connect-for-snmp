...
| worker.poller.concurrency                                | Minimum number of threads in a poller worker                                                                                    | 4                 |
| worker.poller.prefetch                                   | Number of tasks consumed from the queue at once                                                                                 | 1                 |
| worker.poller.autoscaling.enabled                        | Enabling autoscaling for poller worker                                                                                          | false             |
| worker.poller.autoscaling.minReplicas                    | Minimum number of running poller workers when autoscaling is enabled                                                            | 2                 |
| worker.poller.autoscaling.maxReplicas                    | Maximum number of running poller workers when autoscaling is enabled                                                            | 10                |
| worker.poller.autoscaling.targetCPUUtilizationPercentage | CPU % threshold that must be exceeded on poller workers to spawn another replica                                                | 80                |
...
| worker.trap.concurrency                                  | Minimum number of threads in a trap worker                                                                                      | 4                 |
...
| worker.trap.autoscaling.enabled                          | Enabling autoscaling for trap worker                                                                                            | false             |
| worker.trap.autoscaling.minReplicas                      | Minimum number of running trap workers when autoscaling is enabled                                                              | 2                 |
| worker.trap.autoscaling.maxReplicas                      | Maximum number of running trap workers when autoscaling is enabled                                                              | 10                |
| worker.trap.autoscaling.targetCPUUtilizationPercentage   | CPU % threshold that must be exceeded on trap workers to spawn another replica                                                  | 80                |
| worker.trap.resources.limits                             | The resource limits for trap worker container                                                                                   | cpu: 500m         |
| worker.trap.resources.requests                           | The requested resources for trap worker container                                                                               | cpu: 250m         |
| worker.sender.replicaCount                               | The number of sender worker replicas                                                                                            | 1                 |
| worker.sender.concurrency                                | Minimum number of threads in a sender worker                                                                                    | 4                 |
| worker.sender.prefetch                                   | Number of tasks consumed from the queue at once                                                                                 | 30                |
| worker.sender.autoscaling.enabled                        | Enabling autoscaling for sender worker                                                                                          | false             |
| worker.sender.autoscaling.minReplicas                    | Minimum number of running sender workers when autoscaling is enabled                                                            | 2                 |
| worker.sender.autoscaling.maxReplicas                    | Maximum number of running sender workers when autoscaling is enabled                                                            | 10                |
| worker.sender.autoscaling.targetCPUUtilizationPercentage | CPU % threshold that must be exceeded on sender workers to spawn another replica                                                | 80                |
| worker.sender.resources.limits                           | The resource limits for sender worker container                                                                                 | cpu: 500m         |
| worker.sender.resources.requests                         | The requested resources for sender worker container                                                                             | cpu: 250m         |
