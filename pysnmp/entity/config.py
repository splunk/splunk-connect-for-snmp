...
def addV1System(snmpEngine, communityIndex, communityName,
    ...
    logging.info('addV1System: added new table entry '
...
def addV3User(snmpEngine, userName,
    ...
    logging.info("usmUserEntry1")
    logging.info(usmUserEntry)
    ...
    logging.info("usmUserEntry2")
    logging.info(usmUserEntry)
    logging.info('addV3User: added new table entries '
